...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_qandaprofile', (
        ...
        db.send_create_signal('accounts', ['QandaProfile'])


    def backwards(self, orm):
        # Deleting model 'QandaProfile'
        db.delete_table('accounts_qandaprofile')


    models = {
        'accounts.qandaprofile': {
            'Meta': {'object_name': 'QandaProfile'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mugshot': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'}),
            'privacy': ('django.db.models.fields.CharField', [], {'default': "'registered'", 'max_length': '15'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'qanda_profile'", 'unique': 'True', 'to': "orm['auth.User']"})
        },
        'auth.group': {
