...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.viewCount'
        db.delete_column('qanda_app_question', 'viewCount')
    ...
    def backwards(self, orm):
        # Adding field 'Question.viewCount'
        db.add_column('qanda_app_question', 'viewCount',
