...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reply.answer'
        db.add_column('qanda_app_reply', 'answer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='replies', null=True, to=orm['qanda_app.Answer']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reply.answer'
        db.delete_column('qanda_app_reply', 'answer_id')
