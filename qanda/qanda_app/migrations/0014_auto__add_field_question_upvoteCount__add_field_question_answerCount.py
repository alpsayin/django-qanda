...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.upvoteCount'
        db.add_column('qanda_app_question', 'upvoteCount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Question.answerCount'
        db.add_column('qanda_app_question', 'answerCount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.upvoteCount'
        db.delete_column('qanda_app_question', 'upvoteCount')

        # Deleting field 'Question.answerCount'
        db.delete_column('qanda_app_question', 'answerCount')
    ...
    models = {
        ...
        'qanda_app.question': {
            ...
            'upvoteCount': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
