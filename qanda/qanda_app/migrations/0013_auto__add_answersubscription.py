...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AnswerSubscription'
        db.create_table('qanda_app_answersubscription', (
            ('subscription_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['django_notify.Subscription'], unique=True, primary_key=True)),
            ('answer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriptions', to=orm['qanda_app.Answer'])),
        ))
        db.send_create_signal('qanda_app', ['AnswerSubscription'])


    def backwards(self, orm):
        # Deleting model 'AnswerSubscription'
        db.delete_table('qanda_app_answersubscription')
