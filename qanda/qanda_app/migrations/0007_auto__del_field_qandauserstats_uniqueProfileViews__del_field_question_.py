...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QandaUserStats.uniqueProfileViews'
        db.delete_column('qanda_app_qandauserstats', 'uniqueProfileViews')

        # Deleting field 'Question.uniqueViewCount'
        db.delete_column('qanda_app_question', 'uniqueViewCount')


    def backwards(self, orm):
        # Adding field 'QandaUserStats.uniqueProfileViews'
        db.add_column('qanda_app_qandauserstats', 'uniqueProfileViews',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Question.uniqueViewCount'
        db.add_column('qanda_app_question', 'uniqueViewCount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    models = {
        ...
        'qanda_app.userstars': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'starred': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'starred_relation'", 'to': "orm['qanda_app.QandaUser']"}),
            'starrer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'starrer_relation'", 'to': "orm['qanda_app.QandaUser']"}),
