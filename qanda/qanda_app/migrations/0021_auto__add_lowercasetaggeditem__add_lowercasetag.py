...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('qanda_app_lowercasetaggeditem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('object_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='qanda_app_lowercasetaggeditem_tagged_items', to=orm['contenttypes.ContentType'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tagged_items', to=orm['qanda_app.LowerCaseTag'])),
        ))
        db.send_create_signal('qanda_app', ['LowerCaseTaggedItem'])

        # Adding model 'LowerCaseTag'
        db.create_table('qanda_app_lowercasetag', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100)),
        ))
        db.send_create_signal('qanda_app', ['LowerCaseTag'])


    def backwards(self, orm):
        # Deleting model 'LowerCaseTaggedItem'
        db.delete_table('qanda_app_lowercasetaggeditem')

        # Deleting model 'LowerCaseTag'
        db.delete_table('qanda_app_lowercasetag')
    ...
    models = {
        ...
        'qanda_app.lowercasetag': {
            'Meta': {'object_name': 'LowerCaseTag'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '100'})
        },
        'qanda_app.lowercasetaggeditem': {
            'Meta': {'object_name': 'LowerCaseTaggedItem'},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'qanda_app_lowercasetaggeditem_tagged_items'", 'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object_id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tagged_items'", 'to': "orm['qanda_app.LowerCaseTag']"})
        },
        'qanda_app.qandauser': {
