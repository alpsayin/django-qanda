...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.editDate'
        db.alter_column('qanda_app_question', 'editDate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Question.closeDate'
        db.alter_column('qanda_app_question', 'closeDate', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Question.editDate'
        db.alter_column('qanda_app_question', 'editDate', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Question.closeDate'
        db.alter_column('qanda_app_question', 'closeDate', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'qanda_app.question': {
            ...
            'closeDate': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'editDate': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'postDate': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
