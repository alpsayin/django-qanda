...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reply.editDate'
        db.alter_column('qanda_app_reply', 'editDate', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'UserStars.timestamp'
        db.alter_column('qanda_app_userstars', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'Reply.editDate'
        db.alter_column('qanda_app_reply', 'editDate', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

        # Changing field 'UserStars.timestamp'
        db.alter_column('qanda_app_userstars', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))
