...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionSeen'
        db.create_table('qanda_app_questionseen', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qanda_app.Question'])),
            ('seen_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qanda_app.QandaUser'])),
            ('seen_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('qanda_app', ['QuestionSeen'])


    def backwards(self, orm):
        # Deleting model 'QuestionSeen'
        db.delete_table('qanda_app_questionseen')
    ...
    models = {
        ...
        'qanda_app.question': {
            ...
            'closeMessage': ('django.db.models.fields.CharField', [], {'default': "u'Bu soru site y\\xf6neticileri taraf\\u0131ndan kapat\\u0131lm\\u0131\\u015ft\\u0131r. http://localhost:8000/qanda/'", 'max_length': '511', 'blank': 'True'}),
            ...
            'seen_by': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'questions_seen'", 'symmetrical': 'False', 'through': "orm['qanda_app.QuestionSeen']", 'to': "orm['qanda_app.QandaUser']"}),
        ...
        'qanda_app.questionseen': {
            'Meta': {'object_name': 'QuestionSeen'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qanda_app.Question']"}),
            'seen_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qanda_app.QandaUser']"}),
            'seen_time': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
