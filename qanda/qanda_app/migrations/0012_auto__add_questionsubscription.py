...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('qanda_app_questionsubscription', (
            ...
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriptions', to=orm['qanda_app.Question'])),
        ))
        db.send_create_signal('qanda_app', ['QuestionSubscription'])


    def backwards(self, orm):
        # Deleting model 'QuestionSubscription'
        db.delete_table('qanda_app_questionsubscription')
