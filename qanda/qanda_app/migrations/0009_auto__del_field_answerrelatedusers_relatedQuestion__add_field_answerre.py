...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AnswerRelatedUsers.relatedQuestion'
        db.delete_column('qanda_app_answerrelatedusers', 'relatedQuestion_id')

        # Adding field 'AnswerRelatedUsers.relatedAnswer'
        db.add_column('qanda_app_answerrelatedusers', 'relatedAnswer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['qanda_app.Answer']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AnswerRelatedUsers.relatedQuestion'
        db.add_column('qanda_app_answerrelatedusers', 'relatedQuestion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=False, to=orm['qanda_app.Answer']),
                      keep_default=False)

        # Deleting field 'AnswerRelatedUsers.relatedAnswer'
        db.delete_column('qanda_app_answerrelatedusers', 'relatedAnswer_id')
    ...
    models = {
        ...
        'qanda_app.answerrelatedusers': {
            ...
            'relatedAnswer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['qanda_app.Answer']"}),
