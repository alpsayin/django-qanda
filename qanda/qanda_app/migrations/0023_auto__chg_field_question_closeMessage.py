...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Question.closeMessage'
        db.alter_column('qanda_app_question', 'closeMessage', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'qanda_app.question': {
            ...
            'closeMessage': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
