...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('qanda_app_category', ['slug'])


        # Changing field 'Category.slug'
        db.alter_column('qanda_app_category', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))
        # Adding index on 'Category', fields ['slug']
        db.create_index('qanda_app_category', ['slug'])


    def backwards(self, orm):
        # Removing index on 'Category', fields ['slug']
        db.delete_index('qanda_app_category', ['slug'])


        # Changing field 'Category.slug'
        db.alter_column('qanda_app_category', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))
        # Adding unique constraint on 'Category', fields ['slug']
        db.create_unique('qanda_app_category', ['slug'])
