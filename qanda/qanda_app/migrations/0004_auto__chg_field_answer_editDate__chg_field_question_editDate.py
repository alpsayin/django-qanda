...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Answer.editDate'
        db.alter_column('qanda_app_answer', 'editDate', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Answer.editDate'
        db.alter_column('qanda_app_answer', 'editDate', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

        # Changing field 'Question.editDate'
        db.alter_column('qanda_app_question', 'editDate', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))
