...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionRelatedUsers.seen'
        db.add_column('qanda_app_questionrelatedusers', 'seen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionRelatedUsers.seen'
        db.delete_column('qanda_app_questionrelatedusers', 'seen')
