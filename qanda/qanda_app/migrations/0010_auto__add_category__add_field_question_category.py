...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('qanda_app_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('qanda_app', ['Category'])

        # Adding field 'Question.category'
        db.add_column('qanda_app_question', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qanda_app.Category'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Category'
        db.delete_table('qanda_app_category')

        # Deleting field 'Question.category'
        db.delete_column('qanda_app_question', 'category_id')
