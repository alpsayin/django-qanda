...
urlpatterns = patterns('qanda_app',
    ...
    url(r'^user/(?P<user_id>\d+)/answered/(?P<question_id>\d+)/$', user_answered_questions_list, name='user_answered_questions_list'),
    url(r'^user/(?P<user_id>\d+)/answered/(?P<question_id>\d+)/(?P<category>\w+)/$', user_answered_questions_list, {'category' : 'all'}, name='categorized_user_answered_questions_list'),
    url(r'^user/(?P<user_id>\d+)/replied/(?P<question_id>\d+)/$', user_replied_questions_list, name='user_replied_questions_list'),
    url(r'^user/(?P<user_id>\d+)/replied/(?P<question_id>\d+)/(?P<category>\w+)/$', user_replied_questions_list, { 'category' : 'all'}, name='categorized_user_replied_questions_list'),
